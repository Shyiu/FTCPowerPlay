...
public class IMUTurning extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        long runTimeMs = 45;//In seconds
        runTimeMs *= 1000;//Convert to ms
        while (opModeIsActive() && System.currentTimeMillis() - startTime < runTimeMs)
        {
            ...
            telemetry.addData(String.valueOf(power - correction), power + correction);
            telemetry.update();
