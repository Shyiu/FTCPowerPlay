...
public class MecanumDrive extends com.acmerobotics.roadrunner.drive.MecanumDrive {
    ...
    public static double SLIDE_POWER = .7;
    ...
    private DcMotorSimple flapper;
    private NormalizedColorSensor color;
    private Encoder leftRearEncoder, leftFrontEncoder, rightRearEncoder, rightFrontEncoder;
    ...
    public MecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.5, 0.5, Math.toRadians(5.0)), 0.025);
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, m.fl);
        leftRear = hardwareMap.get(DcMotorEx.class, m.bl);
        rightRear = hardwareMap.get(DcMotorEx.class, m.br);
        rightFront = hardwareMap.get(DcMotorEx.class, m.fr);
