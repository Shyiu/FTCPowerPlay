 ...
 */
@Config
public class DualOmniDrive extends TankDrive {
    public static PIDCoefficients AXIAL_PID = new PIDCoefficients(4, 0, 0);
    public static PIDCoefficients CROSS_TRACK_PID = new PIDCoefficients(0.08, 0, 0);
    ...
    public DualOmniDrive(HardwareMap hardwareMap) {
